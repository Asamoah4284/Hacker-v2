      ...
      <div className='flex items-center gap-3'>
        ...
        <NavLink to='/' className='flex items-center group'>
          <div className='relative h-12 w-auto'>
            ...
            <div 
              className='absolute inset-0 h-12 w-auto bg-gradient-to-r from-[#d7906e] to-[#e9b19b] rounded-lg opacity-70 mix-blend-color group-hover:scale-105 transition-transform'
              style={{
