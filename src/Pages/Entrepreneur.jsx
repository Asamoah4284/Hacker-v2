      ...
      <section className='relative py-24 overflow-hidden bg-gradient-to-br from-[#18181b] via-[#232326] to-[#18181b]'>
        ...
        <div className='container mx-auto px-8 md:px-16 xl:px-32 text-center relative z-10'>
          ...
          <p className='text-2xl text-[#a1a1aa] max-w-2xl mx-auto mb-10'>
            ...
            talented artisans who are preserving cultural heritage through their craft.
          </p>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-8 md:px-16 xl:px-32'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-white mb-4'>Featured Artisans</h2>
          ...
          {loading ? (
            ...
            <>
                  ...
                  return (
                    <div key={artisan.id} className='bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl border border-white/10 p-8 hover:bg-white/15 transition-all duration-300 hover:scale-105'>
                      ...
                      <div className='space-y-3 mb-6'>
                        ...
                        <div className='flex items-center gap-4'>
                          ...
                          <div className='flex items-center gap-1'>
                            ...
                            <span className='text-white font-bold'>{artisan.productCount}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {artisan.products && artisan.products.length > 0 && (
                        <div className='mb-6'>
                          <h4 className='text-white font-semibold mb-3'>Sample Products:</h4>
                          <div className='grid grid-cols-2 gap-2'>
                            {artisan.products.slice(0, 2).map((product, index) => (
                              <div key={index} className='bg-white/5 rounded-lg p-2'>
                                <div className='text-xs text-[#a1a1aa] truncate'>{product.name}</div>
                                <div className='text-xs text-[#d4845b] font-semibold'>${product.price}</div>
                              </div>
                            ))}
                          </div>
                        </div>
              ...
              {filteredArtisans.length === 0 && !loading && (
                <div className='text-center py-20'>
                  <p className='text-[#a1a1aa] text-xl'>No artisans found matching your criteria.</p>
                  <button 
                    onClick={() => {
      ...
      <section className='py-20 bg-white/5'>
        <div className='container mx-auto px-8 md:px-16 xl:px-32 text-center'>
          ...
          <p className='text-xl text-[#a1a1aa] max-w-2xl mx-auto mb-8'>
            Are you an African artisan with a story to tell? Join our platform and connect with customers worldwide.
          </p>
        ...
        <div className='container mx-auto px-8 md:px-16 xl:px-32 grid grid-cols-1 md:grid-cols-5 gap-14 mb-10'>
          <div>
            ...
            <p className='text-lg text-[#a1a1aa] mb-4'>
              Empowering African artisans worldwide through a marketplace
